...
% using docsteady version 1.1rc6
...
that require output from the LSST science pipelines as input.\\
~\\
This test is a general purpose pre-requisite test case, it is not
related to any requirements.
